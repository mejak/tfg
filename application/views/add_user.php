...
<div class="row">
    <div class="col-md-12">
        <div class="x_panel">
          <div class="x_title">
            <h2><?php echo $this->lang->line('add_user_heading') ?></h2>
          ...
          <div class="x_content">
            ...
            <div class="row">
              <div class="col-sm-8">
                <form id="add_user_form"  class="form-horizontal" action="<?php echo base_url() ?>index.php/users/add" method="post">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <input type="text" name="username" class="form-control" id="username"  value="<?php echo set_value('username') ?>" placeholder="<?php echo $this->lang->line('signup_placeholder_username') ?>" >
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="email" class="col-sm-4 control-label"><?php echo $this->lang->line('user_label_email') ?></label>
                    <div class="col-sm-8">
                      <input type="email" name="email" class="form-control" id="email" value="<?php echo set_value('email') ?>" placeholder="<?php echo $this->lang->line('signup_placeholder_email') ?>" >
                    </div>
                  </div>
                  <div class="form-group">
                  ...
                  <script type="text/javascript">
                    $('#usertype').val('<?php echo set_value('usertype') ? set_value('usertype') : USER_TYPE_USER ?>')
                  </script>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <input type="number" name="page_limit" class="form-control" id="page_limit" value="<?php echo $this->config->item('default_user_page_limit') ?>" placeholder="<?php echo $this->lang->line('user_label_page_limit') ?>" >
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <label>
                        ...
                        <input type="checkbox" class="js-switch" name="insights_allowed" value="<?php echo INSIGHTS_ALLOWED_YES ?>" <?php if($this->config->item('new_user_insight_allowed')) echo  'checked' ?>  />
                      </label>
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <button type="submit"  class="btn btn-primary" ><?php echo $this->lang->line('user_btn_add_user') ?></button>
                    </div>
                  </div>
                </form>
              </div>
