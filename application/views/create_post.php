...
<?php $this->load->view('create_post_controller'); ?>
<div class="row well" ng-app="fbcmpapp" ng-controller="postController">
  <h4><?php echo $this->lang->line('create_post_heading') ?></h4>
  <hr> 
    ...
    <div class="row setup-content" id="step-1" ng-cloak>
      ...
      <div class="col-sm-12" >
        <ul class="nav nav-tabs post_tabs margin-btm-20" role="tablist">
          <li role="presentation" class="active"><a ng-click="post_type='status'" href="#status" aria-controls="status" role="tab" data-toggle="tab"><?php echo $this->lang->line('create_post_type_status') ?></a></li>
          <li role="presentation"><a ng-click="post_type='link'" href="#link" aria-controls="link" role="tab" data-toggle="tab"><?php echo $this->lang->line('create_post_type_link') ?></a></li>
          <li role="presentation"><a ng-click="post_type='photo'" href="#photo" aria-controls="photo" role="tab" data-toggle="tab"><?php echo $this->lang->line('create_post_type_photo') ?></a></li>
          <li role="presentation"><a ng-click="post_type='video'" href="#video" aria-controls="video" role="tab" data-toggle="tab"><?php echo $this->lang->line('create_post_type_video') ?></a></li>
        </ul>
